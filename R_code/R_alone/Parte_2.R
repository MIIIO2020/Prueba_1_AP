...
data_test=fread(paste('C:/Users/rolft/Documents/UAI/UAI_2020/',
                'AP_git/me_code/Prueba_1/',
                'data/20949_Test.csv',sep=""))
data_train=fread(paste('C:/Users/rolft/Documents/UAI/UAI_2020/',
                       'AP_git/me_code/Prueba_1/',
                       'data/20949_Train.csv',sep=""))
