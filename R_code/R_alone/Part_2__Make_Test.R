...
Test<-data[V1>=2882335,]#2882335 comienza en adelante la data de Test
Test$V1<- NULL
Test$date_block_num<- NULL
...
Todo_I$item_cnt_day<-lapply(Todo_I$item_cnt_day, function(x) ifelse(x<=0,0, log(x) ) )
